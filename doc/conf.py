...
# in case we want to use numpy's sphinx extensions we have to add their
# sphinxext directory to the python module search path
# after that, we can add 'numpydoc' to the extensions list
...
project = "VG"
copyright = "2019, Dirk Schlabing, Magdalena Eder, and others"
